...
namespace Larpx.ResourceSpider.Engine
{
    ...
    {
        public SQLServerSQLSugarHelper(DatabaseType bDbType = DatabaseType.SqlServer, bool bLog = false)
        {
            switch (bDbType)
            {
    ...
    {
        public MySQLSQLSugarHelper(DatabaseType bDbType = DatabaseType.SqlServer, bool bLog = false)
        {
            switch (bDbType)
            {
                case DatabaseType.MySql:

    ...
    public class HttpClientDownloader : IDownloader
    {
        ...
        public async Task<Response> DownloadAsync(Request request)
        {
            try
            {
                ...
                {
                    _logger.LogError($"{request.RequestUri} 下载失败，拨号程序有误，错误内容：{matchValue}");
                    ...
                    return new Response
                    {
                        ...
                        {
                            Data = Encoding.UTF8.GetBytes($"拨号失败，错误内容：{matchValue}")
                        }
                    };
                }
                else
        ...
        private HttpRequestMessage GenerateHttpRequestMessage(Request request)
        {
            ...
            {
                httpRequestMessage.Headers.TryAddWithoutValidation("User-Agent", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.149 Safari/537.36 Edg/80.0.361.69");
            }

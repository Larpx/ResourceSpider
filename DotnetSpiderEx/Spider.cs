...
using Larpx.ResourceSpider.DotnetSpiderEx.Extensions;
...
using Larpx.ResourceSpider.DotnetSpiderEx.RequestSupplier;
...
[assembly: InternalsVisibleTo("Larpx.ResourceSpider.DotnetSpiderEx.Tests")]
                ...
                while (!stoppingToken.IsCancellationRequested)
                {
                    ...
                    if (requests.Length > 0)
                    {
                        ...
                        foreach (var request in requests)
                        {
                            ...
                            // https://github.com/dotnetcore/Larpx.ResourceSpider.DotnetSpiderEx/issues/182
                            ...
                            {
                                await Task.Delay(waitTimeMillis, cancellationToken: default);
                            }

        ...
        internal abstract class Getter
        {
            ...
            internal bool Get(Type type)
            {
                if (type.IsInterface)
                {
                    ...
                    if (serverAttribute == null) serverAttribute = Larpx.ResourceSpider.BaseLibrary.Emit.Constructor<attributeType>.New();
                    ...
                    {
                        methodAttribute = Larpx.ResourceSpider.BaseLibrary.Emit.Constructor<methodAttributeType>.New();

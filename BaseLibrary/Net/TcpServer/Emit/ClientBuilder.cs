...
namespace Larpx.ResourceSpider.BaseLibrary.Net.TcpServer.Emit
{
    ...
    internal sealed partial class Method<attributeType, methodAttributeType, serverSocketSenderType>
    {
        ...
        internal struct ClientBuilder
        {
            ...
            {
                TypeBuilder typeBuilder = Larpx.ResourceSpider.BaseLibrary.Emit.Builder.Module.Builder.DefineType(Metadata.ClientTypeName + ".Emit." + type.FullName, TypeAttributes.Class | TypeAttributes.Sealed, Metadata.MethodClientType, new Type[] { type });

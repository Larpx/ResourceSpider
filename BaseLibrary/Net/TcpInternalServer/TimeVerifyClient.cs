...
namespace Larpx.ResourceSpider.BaseLibrary.Net.TcpInternalServer
{
    ...
    public static class TimeVerifyClient
    {
        ...
        /// <returns></returns>
        public unsafe static bool Verify(Verifier verify, ClientSocketSender sender, Net.TcpInternalServer.Client client)
        {
        ...
        /// <returns></returns>
        public unsafe static bool Verify(Verifier verify, ClientSocketSender sender, Net.TcpInternalServer.Client client, string userID, string verifyString)
        {
            long ticks;

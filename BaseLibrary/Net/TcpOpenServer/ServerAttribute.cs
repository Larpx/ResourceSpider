...
namespace Larpx.ResourceSpider.BaseLibrary.Net.TcpOpenServer
{
    ...
    public unsafe class ServerAttribute : TcpServer.ServerAttribute
    {
        ...
        /// 默认二进制反序列化配置参数
        /// </summary>
        internal static readonly BinarySerialize.DeSerializeConfig DefaultBinaryDeSerializeConfig = BinarySerialize.ConfigLoader.GetUnion(typeof(BinarySerialize.DeSerializeConfig), BinaryDeSerializeConfigName).DeSerializeConfig ?? new BinarySerialize.DeSerializeConfig { IsDisposeMemberMap = true, MaxArraySize = 1024 };
        /// <summary>
        /// 获取二进制反序列化配置参数
        /// </summary>
        ...
        internal static BinarySerialize.DeSerializeConfig GetBinaryDeSerializeConfig(int maxArraySize)
        {
            if (maxArraySize == BinarySerialize.DeSerializer.DefaultConfig.MaxArraySize) return BinarySerialize.DeSerializer.DefaultConfig;
            if (maxArraySize == DefaultBinaryDeSerializeConfig.MaxArraySize) return DefaultBinaryDeSerializeConfig;
            return new BinarySerialize.DeSerializeConfig { IsDisposeMemberMap = true, MaxArraySize = maxArraySize };
        }
        ...
        /// <summary>
        /// 服务端自定义队列类型，需要继承自 Net.TcpServer.IServerCallQueueSet
        /// </summary>
        [Metadata.Ignore]

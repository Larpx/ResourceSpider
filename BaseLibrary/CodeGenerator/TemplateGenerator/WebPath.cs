    ...
    internal abstract partial class WebPath
    {
            ...
            where cSharpType : Generator<cSharpType>, new()
        {
            ...
            protected override void nextCreate()
            {
                ...
                object pathValue = typeof(Larpx.ResourceSpider.BaseLibrary.Emit.Constructor<>).MakeGenericType(Type).GetMethod("Default", BindingFlags.Static | BindingFlags.Public | BindingFlags.NonPublic, null, NullValue<Type>.Array, null).Invoke(null, null);

...
namespace Larpx.ResourceSpider.BaseLibrary.CodeGenerator.TemplateGenerator
{
    ...
    internal sealed partial class TcpInternalServer : TcpServer
    {
        ...
        internal sealed partial class Generator : Generator<Net.TcpInternalServer.ServerAttribute, Net.TcpServer.MethodAttribute, Net.TcpInternalServer.ServerSocketSender>
        {
            /// <summary>
            /// 服务类名称
            /// </summary>
            ...
            {
                get { return typeof(Net.TcpInternalServer.TimeVerifyServer).IsAssignableFrom(Type); }
            }
            /// <summary>
            /// 是否生成客户端代码
            /// </summary>
...
#else
                    return typeof(Net.TcpServer.ISetTcpServer<Net.TcpInternalServer.Server>).IsAssignableFrom(Type.Type)
#endif
                        || Type.Type.GetMethod("SetTcpServer", BindingFlags.Instance | BindingFlags.Public, null, new Type[] { typeof(Net.TcpInternalServer.Server) }, null) != null;
                }
            }
            /// <summary>
            /// 安装下一个类型
            ...
            protected unsafe override void nextCreate()
            {
                ...
                {
                    LeftArray<TcpMethod> methodArray = new LeftArray<TcpMethod>(Metadata.MethodIndex.GetMethods<Net.TcpServer.MethodAttribute>(Type, Attribute.GetMemberFilters, false, Attribute.IsAttribute, Attribute.IsBaseTypeAttribute)
                    ...
                    foreach (MemberIndexInfo member in MemberIndexGroup.Get<Net.TcpServer.MethodAttribute>(Type, Attribute.GetMemberFilters, false, Attribute.IsAttribute, Attribute.IsBaseTypeAttribute))
                    {
                        if (member.IsField)
                        {

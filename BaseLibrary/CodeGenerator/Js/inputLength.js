...
(function (AutoCSer) {
    var InputLength = (function () {
        ...
        InputLength.prototype.Check = function () {
            var Length = HtmlElement.$IdElement(this.Id).value.length;
            if (Length <= this.Length) {
                if (this.ErrorSkinId)
                    Skin.Skins[this.ErrorSkinId].Hide();
                if (this.SkinId) {
        ...
        InputLength.prototype.GetValue = function () {
            var Value = HtmlElement.$IdElement(this.Id).value;

using System;
using Net.TcpInternalSimpleServer;
...
namespace Larpx.ResourceSpider.BaseLibrary.CodeGenerator.Template
{
    class TcpInternalSimpleServer : Pub
    {
...
#if !NOJIT
             : Net.TcpSimpleServer.ISetTcpServer<Net.TcpInternalSimpleServer.Server>
#endif
        ...
        #endregion IF IsSetTcpServer
        {
            ...
            private const Net.TcpServer.ServerTaskType ServerTask = Net.TcpServer.ServerTaskType.Synchronous;
            ...
            public void SetTcpServer(Net.TcpInternalSimpleServer.Server commandServer) { }
            #endregion NOTE
            #region IF IsServerCode
            ...
            /// </summary>
            public sealed class TcpInternalSimpleServer/*IF:IsServerCode*/ : Net.TcpInternalSimpleServer.Server/*IF:IsServerCode*/
            {
                #region IF IsServerCode
                ...
                public TcpInternalSimpleServer(Net.TcpInternalSimpleServer.ServerAttribute attribute = null, Func<System.Net.Sockets.Socket, bool> verify = null/*IF:Type.Type.IsPublic*/, @Type.FullName value = null/*IF:Type.Type.IsPublic*/, Log.ILog log = null)
                    : base(attribute ?? (attribute = Net.TcpInternalSimpleServer.ServerAttribute.GetConfig("@ServerRegisterName", typeof(@Type.FullName))), verify, log, @IsSynchronousVerifyMethod)
                {
            ...
            /// TCP客户端
            /// </summary>
            public partial class TcpInternalSimpleClient : Net.TcpInternalSimpleServer.MethodClient<TcpInternalSimpleClient>
            {
                #region IF IsTimeVerify
                private bool _timerVerify_(TcpInternalSimpleClient client)
                {
                    return Net.TcpInternalSimpleServer.TimeVerifyClient.Verify(verify, client._TcpClient_);
                }
                #region NOTE
                ...
                #endregion IF IsVerifyMethod
                /// <param name="log">日志接口</param>
                public TcpInternalSimpleClient(Net.TcpInternalSimpleServer.ServerAttribute attribute = null/*IF:IsVerifyMethod*/, Func<TcpInternalSimpleClient, bool> verifyMethod = null/*IF:IsVerifyMethod*/, Log.ILog log = null)
                {
                    if (attribute == null)
                    {
                        #region IF IsServerCode
                        attribute = Net.TcpInternalSimpleServer.ServerAttribute.GetConfig("@ServerRegisterName", typeof(@Type.FullName));
                        #endregion IF IsServerCode
                        #region NOT IsServerCode
                        attribute = Config.Loader.Get<Net.TcpInternalSimpleServer.ServerAttribute>("@ServerRegisterName") ?? _DefaultServerAttribute_;
                        if (attribute.Name == null) attribute.Name = "@ServerRegisterName";
                        #endregion NOT IsServerCode
                    }
                    _TcpClient_ = new Net.TcpInternalSimpleServer.Client<TcpInternalSimpleClient>(this, attribute, log/*IF:IsVerifyMethod*/, verifyMethod/*IF:IsTimeVerify*/ ?? (Func<TcpInternalSimpleClient, bool>)_timerVerify_/*IF:IsTimeVerify*//*IF:IsVerifyMethod*/);
                ...
                /// 默认 TCP 调用服务器端配置信息
                /// </summary>
                public static Net.TcpInternalSimpleServer.ServerAttribute _DefaultServerAttribute_
                {
                    get { return Json.Parser.Parse<Net.TcpInternalSimpleServer.ServerAttribute>(@"@AttributeJson"); }
                }
                #endregion NOT IsServerCode
                ...
                /*AT:IsInternalClient*/
                Net.TcpServer.ReturnValue/*IF:MethodIsReturn*/<@MethodReturnType.FullName>/*IF:MethodIsReturn*/ /*PUSH:Method*/@MethodName/*PUSH:Method*/(/*LOOP:InputParameters*//*PUSH:MethodParameter*/@ParameterTypeRefName @ParameterJoinName/*PUSH:MethodParameter*//*LOOP:InputParameters*/)
                {
                    #region IF Attribute.IsExpired
                    #region LOOP InputParameters
                    #region PUSH MethodParameter
    ...
    internal partial class Pub
    {
...
#endif
        {
            ...
            public void SetTcpServer(Net.TcpInternalSimpleServer.Server tcpServer) { }
        }
    }
    #endregion NOTE
}

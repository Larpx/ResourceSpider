        ...
        public void Push(FieldInfo field)
        {
            ...
            if (type.IsValueType)
            {
                ...
                else
                {
                    ...
                    generator.Emit(OpCodes.Call, Larpx.ResourceSpider.BaseLibrary.Emit.Pub.GetNullableHasValue(type));
        ...
        private void push(FieldInfo field, Type nullType = null)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        generator.Emit(OpCodes.Ldflda, field);
                        generator.Emit(OpCodes.Call, Larpx.ResourceSpider.BaseLibrary.Emit.Pub.GetNullableValue(field.FieldType));
                    }
